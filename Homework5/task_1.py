...
def letter_stat(our_str):
    """
        Подсчитывает количество вхождений каждой буквы в строке.

        Параметры:
        -----------
        our_str : str
            Входная строка, в которой нужно подсчитать частоту букв.

        Возвращает:
        ------------
        letters_dict
            Словарь, где ключи — буквы из входной строки, а значения - количество их вхождений в строку.
    """
